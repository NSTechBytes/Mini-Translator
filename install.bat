...
set "zipFile=Mini Translator.zip"
set "extractPath=Mini Translator"
...
start "" "%cd%\Mini Translator\instructions.html"

REM Notify the user
echo The ZIP file has been extracted. Please follow the instructions in the opened HTML file to install the Mini Translator.
